...
<body>
    <form action="postjobprocess.php" method="post">
        ...
        <input type="text" id="positionid" name="positionid" ><br><br><!--pattern="ID\d{3}" maxlength="5" required placeholder="ID001"-->
        
        <!-- <label>Title: </label>
        <input type="text" id="title" name="title" pattern="[A-Za-z0-9 ,.!]{1,10}" maxlength="10">
        <br><br>
